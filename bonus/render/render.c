	...
	render_set_ray(t_game game, t_render *render)
{
	...
	render->shadow = (int)game->shadow + \
		(int)(game->ray[render->index].distance * SHADOW_DISTANCE);
